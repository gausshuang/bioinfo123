...
这是一个专业的生物信息资源导航页面，收录了NAR 2024-2025中的252个重要生物信息资源，包含180个数据库和72个Web工具。页面提供了直观的分类浏览、类型筛选、智能搜索、中英文对照等功能，帮助研究人员快速找到所需的生物信息资源。

## ✨ 主要特性

- 📊 **252个资源**: 180个数据库 + 72个Web工具，涵盖8个生物学领域
- 🔍 **智能搜索**: 支持资源名称和描述的实时搜索
...
数据来源于NAR (Nucleic Acids Research) 2024-2025年数据库特刊，包含252个精选的生物信息资源（180个数据库 + 72个Web工具）。
